const Navbar = () => {
  return (
    <nav className="flex justify-between items-center px-8 py-5 bg-white">
      ...
      <ul className="flex space-x-6 text-gray-800 font-light">
        <li className="text-lg">Services</li>
        <li className="text-lg">Our Work</li>
        <li className="text-lg">About Us</li>
        <li className="text-lg">Insights</li>
      </ul>
    </nav>
  );
};
    ...
    <div data-scroll-section>
      ...
      <div data-scroll data-scroll-section data-scroll-speed="-.8">
        <div className="w-full min-h-[55vh] pt-10 px-5 pr-5 font-['Founder Grotesk']  sm:min-h-[67vh]">
          <div className="textstructure leading-negative">
            <div className="masker">
              <h1 className="uppercase text-[14vw] leading-none font-bold tracking-[-0.05em] is-inview md:text-[10vw] lg:text-[8vw] ">
                We Create
              </h1>
            </div>
        ...
        <div className="border-t-[1.5px] border-zinc-800 mt-[0px] flex flex-col gap-2 uppercase py-7 flex-wrap px-[5vw] md:flex-row md:justify-between md:items-center font-semibold sm:font-[400] ">
          ...
          <h4 className="p-1 px-3 border-[1px] border-zinc-800 rounded-full cursor-pointer hover:bg-zinc-800 hover:text-zinc-50 w-fit">
            Start the project
          </h4>
        </div>
      </div>
